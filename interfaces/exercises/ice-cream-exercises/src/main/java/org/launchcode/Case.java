...
public class Case {
    ...
    public Case() {
        ...
        Topping topping1 = new Topping("Raspberries", 1.25, new ArrayList<>(Arrays.asList("raspberry")));
        Topping topping2 = new Topping("Cookie Dough", 0.75, new ArrayList<>(Arrays.asList("dairy","egg","gluten")));
        Topping topping3 = new Topping("Chocolate Chips", 0.50, new ArrayList<>(Arrays.asList("dairy")));
        Topping topping4 = new Topping("Sprinkles", 0.25, new ArrayList<>(Arrays.asList("none")));
